...
- Describe how the initial test mind map acts as **the primary structure** of this book and as a **toolbox**.
::::
:::
...
-   **A test workflow:** This workflow will primarily guide us in formulating the right questions about our population(s) of interest. The question is related to one or more unknown parameters in the population of interest. This process will generally proceed with data collection using a specific sampling method, followed by a thorough analysis that includes exploratory data analysis and the **most suitable** hypothesis testing based on our primary question(s). We will conclude the process by presenting a compelling storytelling to our stakeholders. @sec-test-workflow will elaborate further on this workflow.
...
- **[Chapter @sec-chi-squared-tests]** introduces the **chi-squared family of tests** (such as the goodness of fit and test of independence) to assess associations within and between categorical variables.
